...
output:
  html_document:
    df_print: paged
<<<<<<< HEAD
subtitle: Lesson Plan 4 - Precipitation Week 4 of 4
=======
subtitle: Lesson Plan 3 - Precipitation Week 3 of 4
>>>>>>> 5e8a8040dde6ece79b1beb511bc01f8f3ff51bfc
fontsize: 12pt
---
...
## Homework 
**No new homework this week.  We will have a homework problem on frequency distributions after Spring Break.**  The homework listed below was assigned last week.  You are welcome to turn in homework in Rmd, pdf, html or Word.  Upload the file into a folder with your name in Google Drive. 
=======
## Reading Assignment
- Read sections 2.7 - 2.8 of the text 
- Article on [Cape Town, South Africa water crisis](https://www.vox.com/world/2018/2/9/16964416/cape-town-water-crisis-day-zero-south-africa) hotlinked and at https://www.vox.com/world/2018/2/9/16964416/cape-town-water-crisis-day-zero-south-africa  
...
3:50 - Feedback to instructor  

## Looking forward to next week
Spring break and the take-home portion of the midterm exam.  
=======
**new problem**
...
ggplot(precip_event, aes(x = year, y = prcp_in)) +
  ...
  scale_y_log10() +
<<<<<<< HEAD
  labs(title = "24-hour precipitation events over the last hundred years",
=======
